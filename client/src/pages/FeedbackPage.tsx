...
const FeedbackPage = () => {
  ...
  return (
    ...
    <>
      ...
      <Helmet>
        <title>Submit Feedback | AssignFlow Hub</title>
        <meta
          name="description"
          content="Share your experience, suggestions, or improvement ideas with the AssignFlow Hub team to help us enhance the platform."
        />
      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-blue-50/30 relative overflow-hidden">
        ...
        {[1, 2, 3, 4].map((i) => (
          <motion.div
            key={i}
            className={`absolute ${i % 2 === 0 ? 'right-10' : 'left-10'} ${i === 1 ? 'top-20' : i === 2 ? 'top-1/3' : i === 3 ? 'bottom-1/3' : 'bottom-20'
              } z-0`}
            animate={{
              y: [0, -20, 0],
            }}
              ...
              <div className="mb-10">
                ...
                <div className="flex items-center justify-center gap-3 mb-4">
                  {[1, 2, 3, 4, 5].map((star) => (
                    ...
                    >
                      <Star
                        className={`w-14 h-14 transition-all duration-300 ${star <= (hoveredStar || rating)
                ...
                >
                  ...
                  <div className="absolute bottom-0 left-0 right-0 h-1 bg-slate-200 rounded-full overflow-hidden">
                    <motion.div
                      ...
                      className={`h-full transition-all duration-300 ${message.length >= 10
