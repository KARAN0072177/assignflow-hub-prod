...
const About = () => {
  ...
  return (
    ...
    <>
      ...
      <Helmet>
        <title>About AssignFlow Hub | Our Mission & Vision</title>
        <meta
          name="description"
          content="Learn about AssignFlow Hub's mission to simplify assignment workflows, enhance academic collaboration, and improve classroom productivity."
        />
        <link rel="canonical" href="https://assignflowhub.karanart.com/about" />
      </Helmet>
