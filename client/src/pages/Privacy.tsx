...
const PrivacyPage = () => {
  ...
  return (
    ...
    <>
      ...
      <Helmet>
        <title>Privacy Policy | AssignFlow Hub</title>
        <meta
          name="description"
          content="Read how AssignFlow Hub collects, processes, stores, and protects user data while ensuring privacy and platform security."
        />
        <link rel="canonical" href="https://assignflowhub.karanart.com/privacy" />
      </Helmet>
