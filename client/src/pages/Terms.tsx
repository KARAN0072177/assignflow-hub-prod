...
const TermsPage = () => {
  ...
  return (
    ...
    <>
      ...
      <Helmet>
        <title>Terms & Conditions | AssignFlow Hub</title>
        <meta
          name="description"
          content="Review the terms and conditions governing the use of AssignFlow Hub, including user responsibilities and platform policies."
        />
        <link rel="canonical" href="https://assignflowhub.karanart.com/terms" />
      </Helmet>
