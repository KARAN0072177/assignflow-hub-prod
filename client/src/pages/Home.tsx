  ...
  return (
    ...
    <>
      ...
      <Helmet>
        ...
        <meta
          name="description"
          content="AssignFlow Hub helps educators and students manage assignments, submissions, grading, classroom collaboration, and real-time updates efficiently."
        />
        <link rel="canonical" href="https://assignflowhub.karanart.com/" />

        {/* Open Graph */}
        <meta property="og:title" content="AssignFlow Hub" />
        <meta property="og:description" content="A modern platform for managing assignments, classrooms, grading, and academic collaboration." />
