...
const CookiePolicyPage = () => {
  ...
  return (
    ...
    <>
      ...
      <Helmet>
        <title>Cookie Policy | AssignFlow Hub</title>
        <meta
          name="description"
          content="Learn how AssignFlow Hub uses cookies and tracking technologies to enhance user experience and platform performance."
        />
        <link rel="canonical" href="https://assignflowhub.karanart.com/cookies" />
      </Helmet>
      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-blue-50/30 relative overflow-hidden">
        ...
        {[1, 2, 3].map((i) => (
          <motion.div
            key={i}
            className={`absolute ${i % 2 === 0 ? 'right-8' : 'left-8'} ${i === 1 ? 'top-32' : i === 2 ? 'top-1/2' : 'bottom-32'
              } z-0`}
            animate={{
              y: [0, -15, 0],
              rotate: [0, 10, 0],
