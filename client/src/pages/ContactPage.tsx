...
const ContactPage = () => {
  ...
  return (
    ...
    <>
      ...
      <Helmet>
        <title>Contact AssignFlow Hub | Support & Inquiries</title>
        <meta
          name="description"
          content="Get in touch with the AssignFlow Hub team for support, feature suggestions, business inquiries, or technical assistance."
        />
        <link rel="canonical" href="https://assignflowhub.karanart.com/contact" />
      </Helmet>
